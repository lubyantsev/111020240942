...
async def create_task(title: str, content: str, priority: int, user_id: int, slug: str):
...
async def update_task(task_id: int, title: str, content: str, priority: int, user_id: int, completed: bool, slug: str):
    for task in tasks:
        if task.id == task_id:
            task.title = title
...
#
#     # Create sample tasks
#     tasks.append(Task(id=1, title="FirstTask", content="Content1", priority=0, user_id=1, completed=False, slug="firsttask"))
#     tasks.append(Task(id=2, title="SecondTask", content="Content2", priority=2, user_id=1, completed=False, slug="secondtask"))
#     tasks.append(Task(id=3, title="ThirdTask", content="Content3", priority=4, user_id=3, completed=False, slug="thirdtask"))
#     tasks.append(Task(id=4, title="FourthTask", content="Content4", priority=6, user_id=3, completed=False, slug="fourthtask"))